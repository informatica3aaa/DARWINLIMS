  ...
  // ``
    ...
    static async getEstados(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [states] ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getEscalas(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [scales] ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getEtapaSolicitud(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [requisition_stages] ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getEstadoCita(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [quotation_states] ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getEstadoMaterial(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [estado_material] ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getFormulas(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [formulas] where active=@active ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getMallas(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [meshes] where active=@active ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getMonedas(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [currencies] where active=@active ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getElementosQuimicos(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [chemical_elements] where active=@active ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getTipoDireccion(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [address_types] where active=@active ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getCompanias(data){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('offset', sql.Int, Number(data.offset))
        .input('limit', sql.Int, Number(data.limit))
        .query(`select * from [companies] where active=@active ORDER BY ID ASC  OFFSET @offset ROWS FETCH NEXT @limit ROWS ONLY`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
    ...
    static async getMails(data, id){
      return await new sql.ConnectionPool(sqlConfig).connect().then(pool => {
        ...
        .input('active', sql.Bit, Number(data.active))
        .input('id', sql.Int, Number(id))
        .query(`select * from [company_mails] where active=@active and [company_id]=@id`)
      }).then(result => {
        let rows = result.recordset;
        sql.close();
        return rows;
