...
const AccionCotizacion = async (data, link)=>{
                                          ...
                                          <td class="container" style="background:#FFFFFF;padding:15px;margin-top:15px;border-top:3px solid rgb(10, 10, 10);border-bottom:3px solid rgb(8, 8, 8);">
                                                <div class="content">
                                                  <table>
                                                      ...
                                                      <tr>
                                                            <td>
                                                            <h4 style="text-align:left">Estimados usuarios</h4>
                                                            ...
                                                            <h3>SE HA CREADO UNA COTIZACION QUE REQUIERE VALIDACION COMERCIAL Y DE PRODUCCIÓN</h3>
                                                            <table>
                                                              <tr align="center">
                                                              ...
                                                              <tr align="center">
                                                                ...
                                                                <td><a href="${url}/quotations/pendingquotations/${data.id}/"><button class="btn-primary">aprobar-rechazar</button>  </a> </td>
                                                              </tr>
                                                            </table>
                                                          </td>
