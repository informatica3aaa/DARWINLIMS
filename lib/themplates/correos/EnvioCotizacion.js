                            ...
                            <div class="content">
                              <table>
                                  ...
                                  <tr>
                                        ...
                                        <table>
                                          <tr align="center">
                                            <td>  <a href="${url}/quotations/confirmacion/3/${link}"><button class="btn-secondary">Rechazo</button>  </a> </td>
                                            <td>  <a href="${url}/quotations/confirmacion/2/${link}"><button class="btn-primary">ACEPTO   </button> </a></td>
                                          </tr>
                                        </table>
                                      </td>
