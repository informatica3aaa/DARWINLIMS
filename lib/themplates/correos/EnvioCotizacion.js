...
const EnvioCotizacion = async (data)=>{
                      ...
                      <td class="container" style="background:#FFFFFF;padding:15px;margin-top:15px;border-top:3px solid rgb(10, 10, 10);border-bottom:3px solid rgb(8, 8, 8);">
                            <div class="content">
                              <table>
                                  ...
                                  <tr>
                                        <td>
                                        <h4 style="text-align:left">Estimado  ${admin} </h4>
                                        <p style="text-align:justify">Informamos a usted que hemos recibido su rendición de cuenta N° <b>${data.folio}</b> con fecha <b>${fecha}</b> hrs. ${ parrafo } , El proceso de su cuenta en el Servicio Electoral, seguirá de la siguiente forma:                                    </p> 
