                            ...
                            <div class="content">
                              <table>
                                  ...
                                  <tr>
                                        ...
                                        <table>
                                          <tr align="center">
                                            <td>  <a href="${url}/cotizacion-rechazo/${link}"><button class="btn-secondary">Rechazo</button>  </a> </td>
                                            <td>  <a href="${url}/cotizacion-aceptar/${link}"><button class="btn-primary">ACEPTO   </button> </a></td>
                                          </tr>
                                        </table>
                                      </td>
