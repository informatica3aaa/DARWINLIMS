const EnvioRequisicion = async (data, link)=>{
                            ...
                            <div class="content">
                              <table>
                                  ...
                                  <tr>
                                        ...
                                        <h3>INGRESO DE REQUISICIÓN </h3>
									</tr>
									<tr>
										<td>
										  <form action="procesar_formulario.php" method="POST">
											<label for="cliente">Cliente:</label>
												<label for="cliente">${data.fantasy_name}:</label>
										</td>
									</tr>
									<tr>
										<td>
											<label for="cotizacion">Número de Cotización:</label>
											<label for="cotizacion">${data.quotation_number}</label>
										</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td>
											<label for="persona_destinataria">Persona Destinataria:</label>
											<input type="text" id="persona_destinataria" name="persona_destinataria" required><br>
										</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td>
											<label for="inserto">Inserto:</label>
											<input type="checkbox" id="inserto" name="inserto"><br>
										</td>
									</tr>
									<tr>
										<td>
											<label for="sin_muestras">Sin Muestras:</label>
											<input type="checkbox" id="sin_muestras" name="sin_muestras"><br>
										</td>
									</tr>
									<tr>
										<td>
